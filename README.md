...
**命令行：**
```powershell
code --install-extension dualmind-0.0.1.vsix
```

**VSCode 界面：** Extensions 侧边栏 → `···` → **Install from VSIX...** → 选中 `.vsix` 文件。
...
<p align="center">
  ...
  <a href="https://github.com/dualmind/dualmind/issues">Issues</a>
</p>
