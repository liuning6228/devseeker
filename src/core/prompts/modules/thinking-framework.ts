...
export const THINKING_FRAMEWORK_MODULE = [
  ...
  '',
  '## Bug Analysis Extension',
  '',
  'When analyzing bugs, errors, or failures, extend your thinking with these 5 dimensions:',
  '',
  '<thinking>',
  '1. **Symptom**: What exactly is failing? What error message/stack trace do I see?',
  '2. **Scope**: When did it start? What changed recently? Is it reproducible?',
  '3. **Hypothesis**: What are the possible root causes? Rank by likelihood.',
  '4. **Evidence**: What data/log/code path can confirm or refute each hypothesis?',
  '5. **Fix Strategy**: What is the minimal, safe fix? What tests verify it?',
  '</thinking>',
  '',
